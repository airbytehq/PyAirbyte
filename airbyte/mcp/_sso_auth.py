...
def render_login_page(
    *,
    ...
    content = f"""
        <div class="container">
            ...
            <form method="POST" action="" class="option">
                {hidden}
                <input type="hidden" name="choice" value="{_CHOICE_DEFAULT}">
            ...
            <form method="POST" action="" class="option">
                {hidden}
                <input type="hidden" name="choice" value="{_CHOICE_SSO}">
    ...
    """
    return create_page(
        content, title="Sign in to Airbyte Cloud", additional_styles=_LOGIN_PAGE_STYLES
    )
