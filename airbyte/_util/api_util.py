...
def get_workspace_with_org_info(
    workspace_id: str,
    *,
    api_root: str,
    client_id: SecretString,
    ...
    This function searches through all organizations the user has access to
    and finds the workspace with the matching ID, returning both workspace
    ...
    Returns:
        Dictionary containing workspace and organization info:
        - workspace_id: The workspace ID
        - workspace_name: The workspace name
        - organization_id: The organization ID the workspace belongs to
        - organization_name: The organization name

    Raises:
        AirbyteMissingResourceError: If the workspace is not found in any organization
    """
    # Get all organizations for the user
    orgs = list_organizations_for_user(
        api_root=api_root,
        client_id=client_id,
        client_secret=client_secret,
    )

    # Search through each organization's workspaces to find the matching workspace
    for org in orgs:
        workspaces = list_workspaces_in_organization(
    ...
    raise AirbyteMissingResourceError(
        ...
        context={
            "workspace_id": workspace_id,
            "message": f"Workspace '{workspace_id}' not found in any organization "
