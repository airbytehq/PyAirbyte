...
from airbyte.caches import BigQueryCacheConfig, BigQueryCache
...
source = ab.get_source(
    ...
    write_strategy="append", force_full_refresh=True
)
...
config = BigQueryCacheConfig(
    project=secret["project_id"],
    credentials_path="/Users/bindipankhudi/Downloads/dataline-integration-testing-15037634a1d1.json",
)

print(config.get_sql_alchemy_url())
run_test_code = False

credentials = service_account.Credentials.from_service_account_file("/Users/bindipankhudi/Downloads/dataline-integration-testing-15037634a1d1.json")
...
if run_test_code: 
    ...
    data = {
            ...
            'created_at': ['2022-02-01T17:02:19+00:00', '2022-02-01T17:02:19+00:00', '2022-02-01T17:02:19+00:00'],
            'updated_at': ['2022-02-01T17:02:19+00:00', '2022-02-01T17:02:19+00:00', '2022-02-01T17:02:19+00:00'],
    }
