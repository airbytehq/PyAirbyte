...
processor = SnowflakeCortexSqlProcessor(cache=cache, catalog=catalog)
...
message1 = AirbyteMessage(type=Type.RECORD, 
                        ...
                        data={"str_col": 'Dogs are number 1', 
                              ...
                              "embedding": [-0.00438284986621647, -0.0037110261657951915, -0.02161210642043671]}, 
                        emitted_at=0))
message2 = AirbyteMessage(type=Type.RECORD, 
                        record=AirbyteRecordMessage(stream="myteststream", 
                        data={"str_col": 'Camels are number 004', 
                              "int_coln": 5, 
...
message3 = AirbyteMessage(type=Type.RECORD, 
                        record=AirbyteRecordMessage(stream="myteststream", 
                        data={"str_col": 'Camels are number 006', 
                              "int_coln": 10, 
